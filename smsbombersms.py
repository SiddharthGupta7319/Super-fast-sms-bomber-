...
def banner():
    ...
    clr()
    logo="""                    
   ████████.  hiii hello welcome to hacking
   ▒▒▒         I am Siddharth. you have any error 
   ▒▒▒█████.  contact on Facebook Siddharth gupta
          ▒▒▒.  contact me on telegram Siddharth gupta
   █████▒▒▒
...
def start(target, counter, delay, ch, cc):
    ...
    while success < (int(bombs)):
        ...
        print("              This Bomber Was Created By Siddharth gupta!!                ")
        print("==================================================================")
        try:
